    ...
    return (
        <>        
            ...
            {pokemon &&
                ...
                >
                    <div
                        className={`${text} h-[1.5rem] text-ws w-full pt-1 px-2 text-right rounded-t-lg`}
                    >
                        #{pokemon.id.toString().padStart(3, '00')}
                    </div>
                    <div className={`w-full f-6 flex items-center justify-content-center`}>
                        <div className={`box-border relative flex w-full h-[5.5rem] basis justify-content-center items-center`}>
