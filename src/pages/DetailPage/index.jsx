...
export const DetailPage = () => {
  ...
  async function fetchPokemonData(id) {
    ...
    try {
      ...
      if(pokemonData) {
        ...
        const nextAndPerviousPokemon = await getNextAndPreviousPokemon(id);
        ...
        const formattedPokemonData = {
          ...
          weight: weight / 10,
          height: height /10, 
          previous: nextAndPerviousPokemon.previous,
          next: nextAndPerviousPokemon.next,
  ...
  const filterAndFormatDescription = (flavorText) => {
    ...
    return flavorText?.filter((text) => text.language.name === "ko").map((text) => text.flavor_text.replace(/\r|\n|\f/g, ''))
  }
  ...
  const formatPokemonStats = ([statHP, statATK, statDEP, statSATK, statSDEF, statSPD]) => [
  ...
  return (
    <article className='flex items-cetner gap-1 flex-col w-full'>
      <div
        className={
          ...
          <section className='w-full flex flex-col z-20 items-center justify-endj relative h-full '>
          ...
          <section className='w-full min-h-[65%] h-full bg-gray-800 z-10 pt-14 flex flex-col items-center gap-3 px-5 pb-4'>
            ...
            <div className='flex w-full items-center justify-between max-w-[400px] text-center'>
              <div className='w-full'>
                ...
                <div className='text-sm flex mt-1 gap-2 text-zinc-200 justify-center items-center'>
                  <Balance/>
                    {pokemon.weight}kg
                </div>
              </div>
              ...
              <div className='w-full'>
                ...
                {pokemon.abilities.map((ability) => (
                  <div key={ability} className='text-zinc-100 text-[0.5rem] capitalize'>{ability}</div>
                ))}
              </div>
            </div>
            ...
            <div className='flex my-8 flex-wrap justfiy-center'>
